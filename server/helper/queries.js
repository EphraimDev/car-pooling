const query = {
  ...
  updateTrip:
    'UPDATE trip SET vehicle_id=$1,origin=$2,destination=$3,trip_date=$4,trip_time=$5,fare=$6 WHERE trip_id = $7 RETURNING vehicle_id, origin, destination, trip_date, trip_time, fare '
};
